...
<div class="page-404 padding ptb-xs-40">
    <div class="container">
                          ...
                          $(document).ready(function(){
                            $("#select-beast").change(function () {
                              ...
                              $("#select-beast option:selected").each(function () {
                                 id_medidaF = $(this).val();
                                $.post("includes/getMedida.php", { id_medidaF:id_medidaF }, function(data){
                                  $("#select-beast2").html(data);
                                  });            
                                });
                              })
                          });
      ...
      <script type="text/javascript">
                            $('#select-beast2').selectize({ create: true, sortField: 'text' });
      </script>
      </head>
        ...
        ?>
                ...
                <form method="POST" action="?pag=<?php echo $_GET['pag']; ?>&fontanero=<?php echo $_GET['fontanero']; ?>&nuevo=1&nuevo1=1" class="form-horizontal">        
                    <div class="form-group">
                      ...
                      <div class="col-md-4">
                          <select  id="select-beast" name="codigo" required >
                            ...
                            <?php 
                              $sth = mysqli_query($link,"SELECT nombre, id_medidaF FROM `producto` WHERE `id_asada` = '".$_SESSION["asada"]."'");

                                while($r2 = mysqli_fetch_assoc($sth)) { ?>
                                    <option value="<?php echo $r2['id_medidaF']; ?>"><?php echo $r2['nombre']; ?></option>
                            <?php } ?>
                          </select>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-4">
                        <select name="select-beast2" id="select-beast2"></select>
                      </div>
                    </div>
                    <div class="form-group">
        ...
        <?php }else { ?>
            ...
            <tr class="warning">
                ...
                <?php 
                    $sth = mysqli_query($link,"SELECT inventario.id_inventario,inventario.id_usuario,inventario.cantidad,inventario.medida,producto.nombre,producto.id_producto FROM inventario,producto WHERE inventario.codigo = producto.id_producto and inventario.id_usuario = '".$_GET["fontanero"]."'");
